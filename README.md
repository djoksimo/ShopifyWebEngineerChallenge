# [Shopify Web Engineer Challenge - Summer 2019](http://www.domainplug.net)

React.JS app that searches for waste items using the Toronto Waste Wizard database. 
Deployed at [www.domainplug.net](http://domainplug.net)
